...
void setup() {
  ...
  //  |сетей необходимо раскоментировать строки 157-160. Это позволит полученый мусор в ОЗУ из памяти EEPROM    |
  ...
  //   ---------------------------------------------------------------------------------------------------------
  //  Ниже необходимо раскоментировать код при первой прошивке.  
  /*
  String ap_ssid = "ESP8266";                 //имя точки доступа
  String ap_pass = "";                        //пароль точки достпа
